        ...
        <>
            <div className="w-full h-screen bg-[#E0E6EC] flex items-center justify-center">
                <div className="artboard phone-1">
                    ...
                    <h4 className="font-semibold text-xl my-2">Login your account</h4>
                    <form onSubmit={submit} autocomplete="on">
                        <label className="input input-bordered flex items-center gap-2">
                            ...
                            <input type="email" className="grow" placeholder="Email" required value={email} onChange={(e) => setEmail(e.target.value)} />
                        </label>
                        ...
                        <Link to={'/'} className="text-md text-blue-500 block">Create your acount</Link>
